...
\newcommand{\NoisesImageWidth}{0.25\textwidth}
...
\begin{figure}
	...
	\adjustbox{width=\textwidth}{
		\begin{tabular}{cccccc}
			...
			\includegraphics[width=\NoisesImageWidth, trim={5em 2.5em 4em 2.5em}, clip]{img/methodology/examples/signal(base).png}
			& \includegraphics[width=\NoisesImageWidth, trim={5em 2.5em 4em 2.5em}, clip]{img/methodology/examples/signal(gaussian).png}
			& \includegraphics[width=\NoisesImageWidth, trim={5em 2.5em 4em 2.5em}, clip]{img/methodology/examples/signal(salt_and_pepper).png} 
			& \includegraphics[width=\NoisesImageWidth, trim={5em 2.5em 4em 2.5em}, clip]{img/methodology/examples/signal(baseline_wander).png} 
			& \includegraphics[width=\NoisesImageWidth, trim={5em 2.5em 4em 2.5em}, clip]{img/methodology/examples/signal(low_frequency_noise).png} 
			& \includegraphics[width=\NoisesImageWidth, trim={5em 2.5em 4em 2.5em}, clip]{img/methodology/examples/signal(local_noise).png} \\
	...
	\caption{The signal, its impaired versions, and their corresponding 2D projections. From top to bottom: \acrlong{GADF}, \acrlong{GASF}, \acrlong{RP}, and \acrlong{MTF}.}
